    ...
    <div className="animate-fadeIn">
      ...
      <section className="bg-white border-b">
        <div className="container-custom">
          <div className="flex">
            <button
              className={`px-4 py-3 font-medium border-b-2 ${activeTab === 'player'
          ...
          {activeTab === 'player' && (
            <div>
              ...
              <div className="mt-6 text-sm text-gray-600">
                <p className="font-bold mb-3 text-base">Stats Legend:</p>

                <div className="bg-gray-50 p-4 rounded-md mb-3">
                  <p className="font-semibold mb-2">Batting Stats:</p>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-x-4 gap-y-2">
                    ...
                    <div><strong>K</strong>: Strikeouts</div>
                    <div><strong>RBI</strong>: Runs Batted In</div>
                    <div><strong>BB</strong>: Walks</div>
                    <div><strong>HBP</strong>: Hit by Pitch</div>
